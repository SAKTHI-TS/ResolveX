...
if (isset($_POST['save_user'])) {
    try {
        ...
        $query = "INSERT INTO leaveapply (user_id, dept, category, date, reason, Year) VALUES ('$user_id','$dept', '$outPassType', '$dateTime', '$reason','$year')";
...
if (isset($_POST['fetch_details'])) {
    ...
    $query = "SELECT * FROM leaveapply WHERE id = '$userid'";
