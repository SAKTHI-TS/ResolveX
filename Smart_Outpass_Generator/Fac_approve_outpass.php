...
$query0 = "SELECT faculty_name, dept, year FROM faculty WHERE user_id = '$faculty_id'";
...
$query = "SELECT student.name, student.user_id, leaveapply.* 
          ...
          WHERE leaveapply.dept = '$department' 
            AND leaveapply.year = '$year' 
            AND leaveapply.status = '1'";
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="list-group list-group-flush px-3 pt-3">
            ...
            <a href="Fac_approve_outpass.php" class="nav-link active">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted"><?php echo htmlspecialchars($row['user_id']); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?php echo date('M j, Y', strtotime($row['date'])); ?></td>
