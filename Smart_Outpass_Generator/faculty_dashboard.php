...
// Get faculty details
$query = "SELECT faculty_name, dept, year FROM faculty WHERE user_id = '$faculty_id'";
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="info-card text-center p-4">
                    ...
                    <h4 class="fw-bold"><?php echo $faculty_id ; ?></h4>
                </div>
            </div>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="info-card text-center p-4">
                    ...
                    <h4 class="fw-bold"><?php echo $department ;?></h4>
                </div>
            </div>
        </div>
